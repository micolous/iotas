...
import device, json, socket, drawlight, setlights
...
# @app.route('/javascripts/<filepath:path>')
# def server_static(filepath):
#     return static_file(filepath, root='/home/mpesce/iotas/www/javascripts')

# @app.route('/images/<filepath:path>')
# def server_static(filepath):
#     return static_file(filepath, root='/home/mpesce/iotas/www/images')

# @app.route('/webfonts/<filepath:path>')
# def server_static(filepath):
#     return static_file(filepath, root='/home/mpesce/iotas/www/webfonts')

# @app.route('/sass/<filepath:path>')
# def server_static(filepath):
#     return static_file(filepath, root='/home/mpesce/iotas/www/sass')
...
if __name__ == '__main__':
	...
	app.licht = device.Holiday(ourname)
	#the_srv = 'wsgiref'  
	the_srv = 'cherrypy'
	print app.licht
